...
void GameObjectsManager::SetCameraPosition(Vector2f aPosition)
{
	ourInstance->myCamera.SetPosition(aPosition);
}

void GameObjectsManager::IncreaseCameraPosition(Vector2f aPosition)
{
	ourInstance->myCamera.IncreasePosition(aPosition);
}

void GameObjectsManager::IncreaseCameraRotation(float aRadian)
{
	ourInstance->myCamera.IncreaseRotation(aRadian);
}
