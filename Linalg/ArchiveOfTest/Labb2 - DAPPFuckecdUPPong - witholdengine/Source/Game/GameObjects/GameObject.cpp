...
void GameObject::SetScale(float aXScale, float aYScale)
{
	...
	myScale = DX2D::Vector2f(aXScale, aYScale);//((windowSizef.x / spriteSizef.x) * aXScale), ((windowSizef.y / spriteSizef.y) * aYScale));
