...
namespace DX2D
{
    ...
    {
		SEngineCreateParameters(){ myHwnd = nullptr; myHInstance = nullptr;  myWindowWidth = 800; myWindowHeight = 600; myEnableVSync = false; myMaxRenderedObjectsPerFrame = 100000; myRenderWidth = myWindowWidth; myRenderHeight = myWindowHeight; }
    ...
    public:
        ...
        const CTime* GetTime() const { return myTime; }
