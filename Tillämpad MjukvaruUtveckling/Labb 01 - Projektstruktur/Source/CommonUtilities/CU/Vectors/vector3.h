...
namespace CommonUtilities
{
	...
	template<typename T> const Vector3<T> Vector3<T>::DirectionVector45Deg(static_cast<T>(cos(DEGRESS_TO_RADIANSF(45))), static_cast<T>(sin(DEGRESS_TO_RADIANSF(45))), static_cast<T>(sin(DEGRESS_TO_RADIANSF(45))));
}
#include "vector3.inl"
