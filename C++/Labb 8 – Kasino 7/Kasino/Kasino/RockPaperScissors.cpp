...
{
	bool playAgain = Kasino::General::GiveInstructions("Welcome " + aThePlayer.GetPlayerName() + ", to the rock scissors pappers table", "Choose rock, paper or scissors the dealer will do the same. Rock beats scissors, scissors beat paper, paper beat rocks if there is a tie you will play again until someone wins", myCashFlow.GetTableFeelingsState());
