...
{
	bool playAgain = Kasino::General::GiveInstructions("Welcome " + aThePlayer.GetPlayerName() + ", to guess a number table", "Guess a Number between 2-12 then roll a two six sidded dices and compare the results", myCashFlow.GetTableFeelingsState());
