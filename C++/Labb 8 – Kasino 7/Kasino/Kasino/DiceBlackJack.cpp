...
void DiceBlackJack::PlayGame(Player & aThePlayer)
{
	bool playAgain = Kasino::General::GiveInstructions("Welcome " + aThePlayer.GetPlayerName() + ", to the Dice Black Jack table", "You and the dealer will roll three dice each, you will then choose you if you want to roll another dice or stop if you go over 21 you lose. after you are done it will be the dealers turn highest number wins none wins incase of a tie.", myCashFlow.GetTableFeelingsState());
