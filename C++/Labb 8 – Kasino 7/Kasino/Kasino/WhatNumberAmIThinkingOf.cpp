...
void WhatNumberAmIThinkingOf::PlayGame(Player & aThePlayer)
{
	...
	bool playAgain = Kasino::General::GiveInstructions("Welcome " + aThePlayer.GetPlayerName() + ", to think of a number table", "I will think of a number in a really big range then you get as many guesses as you want until either win or give up", myCashFlow.GetTableFeelingsState());
