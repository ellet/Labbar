...
void SpellBook::GetStringOfSpellName(const size_t aSpellIndex, std::string & aStringToBuild) const
{
	aStringToBuild = mySpells[aSpellIndex]->itemNameAndDescription.name;
}
