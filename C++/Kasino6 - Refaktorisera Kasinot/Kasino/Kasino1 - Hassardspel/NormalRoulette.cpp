...
void NormalRoulette(float & aUserMoney, float & aTableStanding)
{
	...
	while (playAgain)
	{
		...
		float odds;
		bool userWin;
		if (Kasino::Roullete::RouletteMenu(userBetAmount, odds, userWin, aUserMoney))
		{
