...
void Go( void )
{
	...
	customShader.PostInit("../source/tutorials/Tutorial10Customshader/custom_sprite_vertex_shader.fx", "../source/tutorials/Tutorial10Customshader//custom_sprite_pixel_shader.fx", Tga2D::EShaderDataBufferIndex_1);
