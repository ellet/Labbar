...
public:     // Constant to avoid using magic numbers
	...
	{
		memcpy(myMatrix, anOther.myMatrix, sizeof(myMatrix));
	}
	...
	Matrix44 &operator =(const Matrix44 &aRight)
	{
		memcpy(myMatrix, aRight.myMatrix, sizeof(myMatrix));
		return *this;
	}
...
#pragma warning( disable : 4201 ) // NOTE: This works fine in VC2013 and GCC so I'm keeping it. //MAHAM
	...
	{
		return myRows[aRow].myElements[aColumn];
	}
...
{
	return memcmp(aLeft.myMatrix, aRight.myMatrix, sizeof(aLeft.myMatrix)) == 0;
}
