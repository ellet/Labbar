...
void FG::TimeHandler::Render()
{
	...
	MainSingleton::GetInstance()->GetRenderer().AddTextRenderCommand(*myFont, CommonUtilities::Vector2f(100, 448), HGETEXT_LEFT, time);
	...
	CommonUtilities::Vector2f first(140.0f, 450.0f);
	CommonUtilities::Vector2f second(140.0f + (300.0f * length), 460.0f);
