...
namespace CommonUtilities
{
	...
	template<typename T>
	Matrix44<T> Matrix44<T>::CreateProjectionMatrixLH(const  T aNearZ, const  T aFarZ, const T aAspectRatio, const  T aFovAngleY)
	{
		Matrix44 temp;
		T    SinFov;
		T    CosFov;
		...
		SinFov = sin(0.5f * aFovAngleY);
		CosFov = cos(0.5f * aFovAngleY);
	...
	//	tempHeight = static_cast<T>(1) / tan(aFovAngleY / static_cast<T>(2));
	//	tempWidth = tempHeight / aAspectRatio;
