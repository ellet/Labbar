...
namespace CommonUtilities
{
	...
	template <class TYPE>
	TYPE& CommonUtilities::Vector2<TYPE>::operator[]( const int& aIndex )
	{
		assert((aIndex>=0) && (aIndex < 2) && "OUT OF BOUNDS ERROR");
		return(*myValues[aIndex]);

	}
	template <class TYPE>
	TYPE& CommonUtilities::Vector2<TYPE>::operator[]( const int& aIndex ) const
	{
		assert((aIndex>=0) && (aIndex < 2) && "OUT OF BOUNDS ERROR");
		return(*myValues[aIndex]);
	}
	...
	template <class TYPE>
	TYPE& CommonUtilities::Vector3<TYPE>::operator[]( const int& aIndex )
	{
		assert((aIndex>=0) && (aIndex < 3) && "OUT OF BOUNDS ERROR");
		return(*myValues[aIndex]);
	}
	template <class TYPE>
	TYPE& CommonUtilities::Vector3<TYPE>::operator[]( const int& aIndex ) const
	{
		assert((aIndex>=0) && (aIndex < 3) && "OUT OF BOUNDS ERROR");
		return(*myValues[aIndex]);
	}
	...
	template <class TYPE>
	TYPE& CommonUtilities::Vector4<TYPE>::operator[]( const int& aIndex )
	{
		assert((aIndex>=0) && (aIndex < 4) && "OUT OF BOUNDS ERROR");
		return(*myValues[aIndex]);
	}
	template <class TYPE>
	TYPE& CommonUtilities::Vector4<TYPE>::operator[]( const int& aIndex ) const
	{
		assert((aIndex>=0) && (aIndex < 4) && "OUT OF BOUNDS ERROR");
		return(*myValues[aIndex]);
	}
