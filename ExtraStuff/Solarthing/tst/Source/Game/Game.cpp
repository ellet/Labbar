...
#ifdef _DEBUG
#pragma comment(lib,"Tga2DEngine_Debug.lib")
#endif // DEBUG
#ifdef NDEBUG
#pragma comment(lib,"Tga2DEngine_Release.lib")
#endif // DEBUG
...
void CGame::Init(const std::wstring& aVersion)
{
	...
	createParameters.myActivateDebugSystems = Tga2D::eDebugFeature_Fps | Tga2D::eDebugFeature_Mem | Tga2D::eDebugFeature_Filewatcher | Tga2D::eDebugFeature_Cpu | Tga2D::eDebugFeature_Drawcalls;
...
void CGame::InitCallBack()
{
	...
	GET_INPUT.Initialize(Tga2D::CEngine::GetInstance()->GetHInstance(), *Tga2D::CEngine::GetInstance()->GetHWND());
}
