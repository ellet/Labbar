...
namespace SB
{
	...
	public:
		...
		inline void Resize(const Type & aFillWith = Type());
	...
	template <typename Type, int size, typename CountType /*= unsigned short*/, bool UseSafeModeFlag /*= true*/>
	void StaticList<Type, size, CountType, UseSafeModeFlag>::Resize(const Type & aFillWith /*= Type()*/)
	{
		Resize(size, aFillWith);
	}
	...
	template <typename Type, int size, typename CountType /*= unsigned short*/, bool UseSafeModeFlag /*= true*/>
	Type& SB::StaticList<Type, size, CountType, UseSafeModeFlag>::GetLast()
	{
	...
	template <typename Type, int size, typename CountType /*= unsigned short*/, bool UseSafeModeFlag /*= true*/>
	const Type& SB::StaticList<Type, size, CountType, UseSafeModeFlag>::GetLast() const
	{
		return (myArray[mySize - 1]);
	}
