...
namespace SB
{
	...
	std::shared_ptr<VertexShader> ShaderFile::GetVertexShader(const std::string& aEntryPoint, const InputLayout & aInputLayout)
	{
		...
		{
			shader = std::make_shared<VertexShader>(GetPath(), aEntryPoint.c_str(), aInputLayout);
