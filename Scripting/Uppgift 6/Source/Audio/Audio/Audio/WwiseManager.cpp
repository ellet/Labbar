...
CWwiseManager::~CWwiseManager()
{
	if (myIsInitialized == true)
	{
		...
		AK::SoundEngine::UnregisterGameObj(DEFAULT_OBJECT);
...
bool CWwiseManager::Init(const char* aInitBank)
{
	...
	AK::SoundEngine::RegisterGameObj(DEFAULT_OBJECT, "Positioning Demo");
	return true;
}
...
void CWwiseManager::PostEvent(const char* aEvent)
{
	if (aEvent == "")
	{
		AK::SoundEngine::PostEvent("Play_MissingSFXAlt", DEFAULT_OBJECT);
	}
	else
	{
		AK::SoundEngine::PostEvent(aEvent, DEFAULT_OBJECT);
	}
}
...
void CWwiseManager::PostEvent(const char* aEvent, int aObjectID)
{
	if (aEvent == "")
	{
		AK::SoundEngine::PostEvent("Play_MissingSFXAlt", aObjectID);
	}
	else
	{
...
void CWwiseManager::SetPosition(float aX, float aY, float aZ, int aObjectID, float aDirectionX /*= 0*/, float aDirectionY /*= 0*/, float aDirectionZ /*= 1.f*/)
{
...
void CWwiseManager::SetListenerPosition(float aX, float aY, float aZ, float aDirectionX /*= 0*/, float aDirectionY /*= 0*/, float aDirectionZ /*= 1.f*/)
{
