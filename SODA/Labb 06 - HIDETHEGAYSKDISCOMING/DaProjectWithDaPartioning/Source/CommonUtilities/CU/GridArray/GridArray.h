...
namespace CommonUtilities
{
	...
	template <typename T, typename CountType /*= unsigned short*/>
	void CommonUtilities::GridArray<T, CountType>::CallFunctionOnAllMembers(std::function<void(const T&)> aFunction) const
	{
		myArray.CallFunctionOnAllMembers(aFunction);
	}

	template <typename T, typename CountType /*= unsigned short*/>
	void CommonUtilities::GridArray<T, CountType>::CallFunctionOnAllMembers(std::function<void(T&)> aFunction)
	{
		myArray.CallFunctionOnAllMembers(aFunction);
	}
