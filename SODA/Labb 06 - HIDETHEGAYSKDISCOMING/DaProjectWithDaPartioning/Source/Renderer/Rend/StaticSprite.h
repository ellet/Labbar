...
public:
	...
	void Init(const std::string & aFilePath = "Sprites/trashTestFiles/biggerTestTile.png", const  CU::Vector2f & aPivotAmount = CU::Vector2f::Half,  bool aIsIsometric = true, const CU::Vector4f & aRect = CU::Vector4f::Zero);
	...
	unsigned short AddImage(const std::string & aFilePath, const  CU::Vector2f & aPivotAmount, const CU::Vector4f & aRect = CU::Vector4f::One);
...
inline void StaticSprite::SetSize(const float aSize)
{
	mySize = aSize;
}
