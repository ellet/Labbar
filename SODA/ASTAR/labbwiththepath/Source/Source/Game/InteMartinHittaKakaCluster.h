...
public:
	...
	void SwitchBlockedNodeWithMouse(const Vector2f & aMouseClickedPosition);
...
private:
	void CreateGridMap(const size_t aNodeIndex);
	void RandomizeMap(const Vector2f & aWorldConstraints);
