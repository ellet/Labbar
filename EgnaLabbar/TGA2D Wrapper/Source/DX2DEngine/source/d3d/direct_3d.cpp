...
void CDirectEngine::SetViewPort(float aTopLeftX, float aTopRightY, float aWidth, float aHeight, float aMinDepth, float aMaxDepth)
{
	// Set the viewport
