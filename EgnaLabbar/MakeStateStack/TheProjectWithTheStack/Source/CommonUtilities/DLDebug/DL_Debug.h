...
//#define DL_ASSERT(statement, string) void; //(statement, string)  if ((statement) == false) { (DL_Debug::Debug::GetInstance()->AssertMessage(__FILE__, __LINE__, __FUNCTION__, (string))); }
