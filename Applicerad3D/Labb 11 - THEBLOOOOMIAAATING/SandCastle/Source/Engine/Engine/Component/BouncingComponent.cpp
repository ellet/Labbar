...
namespace ENGINE_NAMESPACE
{
	...
	void BouncingComponent::RotateTowardsPoint(const Time & aDeltaTime, const Vector3f & aTargetPosition, const float aMaxRotationInDegrees)
	{
		...
		const float MaxRotation = DEGRESS_TO_RADIANSF(aMaxRotationInDegrees);
	...
	void BouncingComponent::DebugDraw()
	{
		...
		Engine::GetDebugger().DrawLine(myPointPaths[myActivatePoint], myPointPaths[myActivatePoint] + myTargetRot.GetRight().GetNormalized() * 5.f , Vector4f(1.f, 0.f, 0.f, 1.f));
		Engine::GetDebugger().DrawLine(myPointPaths[myActivatePoint], myPointPaths[myActivatePoint] + myTargetRot.GetUpward().GetNormalized() * 5.f, Vector4f(0.f, 1.f, 0.f, 1.f));
		Engine::GetDebugger().DrawLine(myPointPaths[myActivatePoint], myPointPaths[myActivatePoint] + myTargetRot.GetForward().GetNormalized() * 5.f, Vector4f(0.f, 0.f, 1.f, 1.f));

		Engine::GetDebugger().DrawLine(myPointPaths[0], myPointPaths[1], Vector4f(1.f, 0.f, 1.f, 1.f));
		Engine::GetDebugger().DrawLine(myPointPaths[2], myPointPaths[1], Vector4f(1.f, 0.f, 1.f, 1.f));
		Engine::GetDebugger().DrawLine(myPointPaths[2], myPointPaths[3], Vector4f(1.f, 0.f, 1.f, 1.f));
		Engine::GetDebugger().DrawLine(myPointPaths[0], myPointPaths[3], Vector4f(1.f, 0.f, 1.f, 1.f));

		Engine::GetDebugger().DrawLine(myObject->GetPosition() + myObject->GetRotation().GetForward() * 5.f, myObject->GetPosition(), Vector4f(0.f, 0.f, 1.f, 1.f));
		Engine::GetDebugger().DrawLine(myObject->GetPosition() + myObject->GetRotation().GetRight() * 5.f, myObject->GetPosition(), Vector4f(1.f, 0.f, 0.f, 1.f));
		Engine::GetDebugger().DrawLine(myObject->GetPosition() + myObject->GetRotation().GetUpward() * 5.f, myObject->GetPosition(), Vector4f(0.f, 1.f, 0.f, 1.f));


		Engine::GetDebugger().DrawLine(myPointPaths[myActivatePoint], myObject->GetPosition(), Vector4f(0.f, 0.f, 0.f, 1.f));
		Engine::GetDebugger().DrawLine(myObject->GetPosition() + myRotAxis.GetNormalized() * 5.f, myObject->GetPosition(), Vector4f(1.f, 0.f, 1.f, 1.f));
		Engine::GetDebugger().DrawLine(myObject->GetPosition() + myObject->GetRotation().GetForward(), myPointPaths[myActivatePoint], Vector4f(0.f, 1.f, 0.f, 1.f));
	...
	/*
		...
		{
			const float RotationSpeed = DEGRESS_TO_RADIANSF(10.f);
			if (myRollLeft)
			{
