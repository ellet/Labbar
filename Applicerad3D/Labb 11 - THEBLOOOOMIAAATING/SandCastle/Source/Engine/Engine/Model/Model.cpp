...
namespace ENGINE_NAMESPACE
{
	...
	void Model::Render(const std::shared_ptr<Effect>& aEffect, const Matrix44f & aMatrix, const Vector4f & aColor) const
	{
	...
	void Model::InstantRender(const std::shared_ptr<Effect>& aEffect, const Matrix44f & aWorldMatrix, const Vector4f & aColor) const
	{
		ModelRenderer & modelRenderer = Engine::GetInstance().GetRenderer().GetModelRenderer();
		InstanceData tempInstanceData;
