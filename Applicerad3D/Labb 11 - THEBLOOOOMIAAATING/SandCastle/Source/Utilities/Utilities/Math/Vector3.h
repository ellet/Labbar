...
namespace ENGINE_NAMESPACE
{
	...
	public:
		...
		static float GetAngleBetweenYlf(const Vector3<TYPE> & aFirstVector, const Vector3<TYPE> & aSecondVector)
		{
			float angle = 0.f;
		...
		static float GetAngleBetween(const Vector3<TYPE> & aFirstVector, const Vector3<TYPE> & aSecondVector)
		{
			...
			return GetAngleFromCross(Vector3<TYPE>::Cross(aFirstVector.GetNormalized(), aSecondVector.GetNormalized()));
		}
