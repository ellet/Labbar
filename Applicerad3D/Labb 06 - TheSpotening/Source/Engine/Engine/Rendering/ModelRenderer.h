...
public:
	...
	void SetPointLight(int aIndex, const Vector3f & aPosition, const Vector3f & aLightColor, const float aRange, const float aIntensity);
	void SetPointLightPosition(int aIndex, const Vector3f & aPosition);
	const Vector3f & GetPointLightPosition(const int aIndex);
