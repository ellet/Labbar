...
void ModelRenderer::SetPointLight(int aIndex, const  Vector3f & aPosition, const Vector3f & aLightColor, const float aRange, const float aIntensity)
{
	myLightingData.myPointLights[aIndex].myPosition = aPosition;
	myLightingData.myPointLights[aIndex].myColor = aLightColor;
	myLightingData.myPointLights[aIndex].myRange = aRange;
	myLightingData.myPointLights[aIndex].myIntensity = aIntensity;
}

void ModelRenderer::SetPointLightPosition(int aIndex, const Vector3f & aPosition)
{
	myLightingData.myPointLights[aIndex].myPosition = aPosition;
}

const Vector3f & ModelRenderer::GetPointLightPosition(const int aIndex)
{
	return myLightingData.myPointLights[aIndex].myPosition;
}
