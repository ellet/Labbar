...
namespace ENGINE_NAMESPACE
{
	...
	{
		std::shared_ptr<RenderTexture> myInputTargetTexture;
		std::shared_ptr<RenderTexture> myVelocityTexture;
	};
	...
	private:
		...
		void CreateMotionTextures(const int aWidth, const int aHeight);
		...
		std::shared_ptr<RenderTexture> myIntermediateRenderTarget;
