...
{
	RenderTexture::RenderTexture(unsigned int aWidth, unsigned int aHeight, bool aGenerateDepthBuffer, const DXGI_FORMAT aFormat)
	{
		myTexture = std::make_shared<Texture>(aWidth, aHeight, true, aFormat);
