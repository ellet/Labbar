...
namespace ENGINE_NAMESPACE
{
	StandardEffect::StandardEffect(const char * aVertexPath, const char * aVertexEntryPoint, const char * aPixelPath, const char * aPixelEntryPoint)
	{
		...
		layout.AddPerInstance("OLD_INSTANCE_MATRIX", 0, DXGI_FORMAT_R32G32B32A32_FLOAT, 1);
		layout.AddPerInstance("OLD_INSTANCE_MATRIX", 1, DXGI_FORMAT_R32G32B32A32_FLOAT, 1);
		layout.AddPerInstance("OLD_INSTANCE_MATRIX", 2, DXGI_FORMAT_R32G32B32A32_FLOAT, 1);
		layout.AddPerInstance("OLD_INSTANCE_MATRIX", 3, DXGI_FORMAT_R32G32B32A32_FLOAT, 1);
