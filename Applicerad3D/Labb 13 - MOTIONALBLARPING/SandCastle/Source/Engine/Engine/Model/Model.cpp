...
namespace ENGINE_NAMESPACE
{
	...
	void Model::Render(const std::shared_ptr<Effect>& aEffect, const Matrix44f & aMatrix, const Matrix44f & aOldMatrix, const Vector4f & aColor) const
	{
		...
		for (size_t i = 0; i < myMeshes.size(); i++)
		{
			...
			tempInstanceData.myOldMatrix = aOldMatrix;
