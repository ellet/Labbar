...
namespace ENGINE_NAMESPACE
{
	...
	public:
		...
		void Render(const std::shared_ptr<Effect>& aEffect, const Matrix44f & aMatrix, const Vector4f & aColor) const;
		void InstantRender(const std::shared_ptr<Effect>& aEffect, const Matrix44f & aWorldMatrix, const Vector4f & aColor) const;
