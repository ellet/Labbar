...
namespace CommonUtilities
{
	...
	public:		// Construction
		...
		T GetAngle180() const;
		void Floor(void);
		void SetWithAngle(const T aAngleInDegrees, const T aDistance = static_cast<T>(1));
		void SetWithAngleRadians(const T aAngleInRadians, const T aDistance = static_cast<T>(1));
