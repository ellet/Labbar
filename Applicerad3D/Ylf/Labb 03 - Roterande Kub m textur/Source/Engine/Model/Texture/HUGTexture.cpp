...
void CHUGTexture::Init(ID3D11Device* aDevice, ID3D11DeviceContext* aDeviceContext, const std::string & aFileName)
{
	HRESULT tempResult = S_OK;


	tempResult = DirectX::CreateDDSTextureFromFile(aDevice, L"Sprites/adam.dds", nullptr, &myTextureView);
