...
namespace ENGINE_NAMESPACE
{
	...
	void ENGINE_NAMESPACE::Heap<TYPE, COMPARER>::Remove(TYPE &aData)
	{
	...
	template<typename TYPE, typename COMPARER>
	ENGINE_NAMESPACE::Heap<TYPE, COMPARER>::Heap() :myArray(10)
	{
		myLastIndex = 0;
		myLastNonLeaf = 0;
	}
	template<typename TYPE, typename COMPARER>
	ENGINE_NAMESPACE::Heap<TYPE, COMPARER>::Heap(unsigned short aSize) :myArray(aSize)
	{
	...
	template<typename TYPE, typename COMPARER>
	TYPE &ENGINE_NAMESPACE::Heap<TYPE, COMPARER>::GetTop()
	{
		return myArray[0];
	}
	template<typename TYPE, typename COMPARER>
	ENGINE_NAMESPACE::Heap<TYPE, COMPARER>::Heap(ENGINE_NAMESPACE::GrowingArray<TYPE, unsigned int> aArray)
	{
		myArray = aArray;
	...
	template<typename TYPE, typename COMPARER>
	void ENGINE_NAMESPACE::Heap<TYPE, COMPARER>::FloydSort()
	{
	...
	template<typename TYPE, typename COMPARER>
	void ENGINE_NAMESPACE::Heap<TYPE, COMPARER>::RecursiveSort(unsigned int aStartIndex)
	{
	...
	template<typename TYPE, typename COMPARER>
	void ENGINE_NAMESPACE::Heap<TYPE, COMPARER>::Enqueue(TYPE aData)
	{
		myArray.Add(aData);
		myLastIndex = myArray.Size()-1;
	...
	template<typename TYPE, typename COMPARER>
	void ENGINE_NAMESPACE::Heap<TYPE, COMPARER>::SiftDown(unsigned int nodeIndex)
	{
	...
	template<typename TYPE, typename COMPARER>
	TYPE ENGINE_NAMESPACE::Heap<TYPE, COMPARER>::Dequeue()
	{
	...
	template<typename TYPE, typename COMPARER>
	void ENGINE_NAMESPACE::Heap<TYPE, COMPARER>::Print()
	{
	...
	template<typename TYPE, typename COMPARER>
	void ENGINE_NAMESPACE::Heap<TYPE, COMPARER>::RemoveAll()
	{
		myArray.RemoveAll();
	}
};