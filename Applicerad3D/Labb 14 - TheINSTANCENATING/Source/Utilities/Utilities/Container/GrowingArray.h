...
namespace ENGINE_NAMESPACE
{
	...
	public:
		...
		inline SizeType Find(const TCompareType & aObject);
	...
	template<typename ObjectType, typename SizeType /*= unsigned short*/>
	void ENGINE_NAMESPACE::GrowingArray<ObjectType, SizeType>::FillFromToCapacity(const ObjectType & aObjectToFillWith, const SizeType aFromIndex)
	{
		FillFromToWith(aObjectToFillWith, aFromIndex, myNrOfItems - 1);
	}

	template<typename ObjectType, typename SizeType /*= unsigned short*/>
	void ENGINE_NAMESPACE::GrowingArray<ObjectType, SizeType>::FillFromToWith(const ObjectType & aObjectToFillWith, const SizeType aFromIndex, const SizeType aToIndex)
	{
	...
	template<typename ObjectType, typename SizeType /*= unsigned short*/>
	void ENGINE_NAMESPACE::GrowingArray<ObjectType, SizeType>::FillToCapactiy(const ObjectType & aObject)
	{
		FillWith(aObject, myNrOfItems);
	}

	template<typename ObjectType, typename SizeType /*= unsigned short*/>
	void ENGINE_NAMESPACE::GrowingArray<ObjectType, SizeType>::FillWith(const ObjectType & aObject, const SizeType aSizeToFillTo)
	{
	...
	*/
	...
	template<typename TCompareType>
	SizeType GrowingArray<ObjectType, SizeType>::Find(const TCompareType & aObject)
	{
		assert(myArray != nullptr && "GROWING ARRAY NOT INITIALIZED!");
