...
namespace ENGINE_NAMESPACE
{
	...
	const std::string& CommandLineParameters::GetFirstValue(const std::string& aParameter, const std::string& aDefaultValue)
	{
		auto &&parameterSet = GetValuesForParameter(aParameter);
		if (parameterSet.begin() != parameterSet.end())
		{
			return *parameterSet.begin();
		}
