...
namespace ENGINE_NAMESPACE
{
	...
	public:
		...
		bool RayTrace(const RayCollider & aRayCollider, CollisionData & aCollisionDataToBuild);
		bool RayTrace(const RayCollider & aRayCollider, GrowingArray<CollisionData> & aCollisionDataToBuild);
