...
{
	class FreeSpaceCameraController : public CameraController, public Subscriber<AnyKeyDownMessage>, public Subscriber<AnyKeyUpMessage>, public Subscriber<RawMouseMoveMessage>
	{
	public:
		...
		ReceiveResult Receive(const RawMouseMoveMessage& aMessage) override;
	...
	private:
		...
		bool myShouldAllowMouseMove;
		bool myEscapePressed;
	};
}
