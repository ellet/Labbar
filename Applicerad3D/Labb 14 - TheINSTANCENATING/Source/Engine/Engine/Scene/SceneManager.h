...
namespace ENGINE_NAMESPACE
{
	...
	public:
		...
		std::shared_ptr<Scene> LoadJsonScene(const char* aFilePath, const eSceneType aType = eSceneType::eMajor);
	...
	{
		mySceneStack.AddScene(std::make_shared<TSceneType>(aArgs...), aType);
		return mySceneStack.GetCurrentScene();
	}
