...
PbrTestScene::PbrTestScene(SB::PostMasterState & aPostMasterState)
	: Scene(aPostMasterState, "PbrTestScene", "grass.dds")
{
	SB::Engine::GetSoundManager().Init("Audio/SoundBanks/Init.bnk");
	SB::Engine::GetSoundManager().LoadBank("Audio/SoundBanks/level1.bnk");

	CreateAndAddModel("Test Spheres", "models/stefan_sphere/testSpheres.fbx", SB::Vector3f(0.f, 0.f, 15.f));
