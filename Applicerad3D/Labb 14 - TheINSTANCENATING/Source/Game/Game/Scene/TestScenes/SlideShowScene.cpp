...
SlideShowScene::SlideShowScene(SB::PostMasterState & aPostMasterState)
	: Scene(aPostMasterState, "skybox.dds")
{
	auto cube = SB::Engine::GetResourceManager().Get<SB::AssimpModel>("models/tga_companioncube/companion.fbx");
	//myObjects.push_back(std::make_shared<ModelInstance>(cube));
	//myObjects.push_back(std::make_shared<ModelInstance>(Engine::GetResourceManager().Get<AssimpModel>("models/crystalAsteroid/crystalAsteroidHigh.fbx")));
	//myObjects.push_back(std::make_shared<ModelInstance>(Engine::GetResourceManager().Get<AssimpModel>("models/pillar/pillarShortObelisk.fbx")));
	//myObjects.push_back(std::make_shared<ModelInstance>(Engine::GetResourceManager().Get<AssimpModel>("models/Asteroid/AsteroidPillarHuge1.fbx")));
	//myObjects.push_back(std::make_shared<ModelInstance>(Engine::GetResourceManager().Get<AssimpModel>("models/Asteroid/AsteroidPillarLarge1.fbx")));
	//myObjects.push_back(std::make_shared<ModelInstance>(Engine::GetResourceManager().Get<AssimpModel>("models/Asteroid/AsteroidPillarLarge2.fbx")));
	//myObjects.push_back(std::make_shared<ModelInstance>(Engine::GetResourceManager().Get<AssimpModel>("models/Asteroid/AsteroidPillarLarge3.fbx")));
	//myObjects.push_back(std::make_shared<ModelInstance>(Engine::GetResourceManager().Get<AssimpModel>("models/Pistol/gunMesh.fbx")));
	//myObjects.push_back(std::make_shared<ModelInstance>(Engine::GetResourceManager().Get<AssimpModel>("models/m4a1/m4a1_s.fbx")));
