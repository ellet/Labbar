...
PlayerTestScene::PlayerTestScene(SB::PostMasterState & aPostMasterState)
	: Scene(aPostMasterState, "PlayerTestScene", "grass.dds")
{
	...
	myPlayer = CreateGameObject("Player");

	myPlayer->CreateComponent<PlayerShootComponent>();
