...
SoundTestScene::SoundTestScene(SB::PostMasterState & aPostMasterState)
	: SB::Scene(aPostMasterState, "Sound Test Scene")
{
	bool success;
	std::shared_ptr<SB::AssimpModel> model = SB::Engine::GetResourceManager().Get<SB::AssimpModel>("models/Modelviewer_Exempelmodell/K11_1415.fbx");
