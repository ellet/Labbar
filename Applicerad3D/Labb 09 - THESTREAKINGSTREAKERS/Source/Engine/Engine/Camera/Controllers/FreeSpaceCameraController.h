...
{
	class FreeSpaceCameraController : public CameraController, public Subscriber<AnyKeyDownMessage>, public Subscriber<AnyKeyUpMessage>, public Subscriber<MouseMovedMessage>
	{
	public:
